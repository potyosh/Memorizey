...
/**
 * Created by yoshi on 2015/01/24.
 */
public class FileDialogActivity extends Activity implements OnClickListener {
     ...
     */
    public FileDialogActivity(Activity activity) {
    ...
    public void show(final String dirPath) {
        ...
        dialog.setPositiveButton("上 へ", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int value) {
                ...
                if (!"/".equals(dirPath)) {
                    ...
                    // 履歴を追加
                    FileDialogActivity.this.viewPathHistory.add(dirPathNew);
        ...
        dialog.setNeutralButton("戻 る", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int value) {
                ...
                int index = FileDialogActivity.this.viewPathHistory.size() - 1;

                if (index > 0) {

                    // 履歴を削除
                    FileDialogActivity.this.viewPathHistory.remove(index);

                    // 1つ前に戻る
                    show(FileDialogActivity.this.viewPathHistory.get(index - 1));
        ...
        dialog.setNegativeButton("キャンセル", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int value) {
                ...
                FileDialogActivity.this.listener.onClickFileSelect(null);
            }
        });
